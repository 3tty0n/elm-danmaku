...
var _user$project$Danmaku$makeImage = A3(_evancz$elm_graphics$Element$image, 1000, 800, 'https://media.giphy.com/media/coKVIxlpTXpXq/giphy.gif');
var _user$project$Danmaku$viewCollage = function (forms) {
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			...
			A2(
				_elm_lang$core$List_ops['::'],
				_evancz$elm_graphics$Collage$toForm(_user$project$Danmaku$makeImage),
				forms)));
};
var _user$project$Danmaku$moveForm = F2(
	function (ms, form) {
		return A2(_evancz$elm_graphics$Collage$moveX, ms / 1000000000000, form);
	});
var _user$project$Danmaku$movedForms = F2(
	function (ms, forms) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Danmaku$moveForm(ms),
			forms);
	});
var _user$project$Danmaku$Model = F2(
	function (a, b) {
		return {input: a, database: b};
	});
var _user$project$Danmaku$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Input':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Danmaku$Model, _p0._0, model.database),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'Send':
			...
			case 'Tick':
				...
				return A2(
					...
					A2(
						_user$project$Danmaku$Model,
						model.input,
						A2(_user$project$Danmaku$movedForms, ms, model.database)),
					_elm_lang$core$Native_List.fromArray(
						[]));
			default:
...
var _user$project$Danmaku$init = {
	ctor: '_Tuple2',
	_0: A2(
		_user$project$Danmaku$Model,
		'',
...
var _user$project$Danmaku$KeyMessage = function (a) {
	return {ctor: 'KeyMessage', _0: a};
};
var _user$project$Danmaku$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Danmaku$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$core$Time$every, _elm_lang$core$Time$millisecond, _user$project$Danmaku$Tick),
				_elm_lang$keyboard$Keyboard$presses(_user$project$Danmaku$KeyMessage)
			]));
};
var _user$project$Danmaku$Send = {ctor: 'Send'};
var _user$project$Danmaku$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _user$project$Danmaku$textField = function (str) {
	return A2(
		_elm_lang$html$Html$input,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$type$('text'),
				_elm_lang$html$Html_Events$onInput(_user$project$Danmaku$Input),
				_elm_lang$html$Html_Attributes$value(str)
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$Danmaku$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Danmaku$Send)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Send')
					])),
				_user$project$Danmaku$viewCollage(model.database)
			]));
};
var _user$project$Danmaku$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Danmaku$init, view: _user$project$Danmaku$view, update: _user$project$Danmaku$update, subscriptions: _user$project$Danmaku$subscriptions})
};

var Elm = {};
Elm['Danmaku'] = Elm['Danmaku'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Danmaku'], 'Danmaku', typeof _user$project$Danmaku$main === 'undefined' ? null : _user$project$Danmaku$main);
