...
var _user$project$Danamku$makeImage = A3(_evancz$elm_graphics$Element$image, 1000, 800, 'https://media.giphy.com/media/coKVIxlpTXpXq/giphy.gif');
var _user$project$Danamku$viewCollage = function (forms) {
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			...
			A2(
				_elm_lang$core$List_ops['::'],
				_evancz$elm_graphics$Collage$toForm(_user$project$Danamku$makeImage),
				forms)));
};
var _user$project$Danamku$moveForm = F2(
	function (ms, form) {
		return A2(_evancz$elm_graphics$Collage$moveX, ms / 1000000000000, form);
	});
var _user$project$Danamku$movedForms = F2(
	function (ms, forms) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Danamku$moveForm(ms),
			forms);
	});
var _user$project$Danamku$Model = F2(
	function (a, b) {
		return {input: a, database: b};
	});
var _user$project$Danamku$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Input':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Danamku$Model, _p0._0, model.database),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'Send':
				var newForm = _evancz$elm_graphics$Collage$text(
					_evancz$elm_graphics$Text$fromString(model.input));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(
						_user$project$Danamku$Model,
						model.input,
						A2(_elm_lang$core$List_ops['::'], newForm, model.database)),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'Tick':
				var ms = _elm_lang$core$Time$inMilliseconds(_p0._0);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(
						_user$project$Danamku$Model,
						model.input,
						A2(_user$project$Danamku$movedForms, ms, model.database)),
					_elm_lang$core$Native_List.fromArray(
						[]));
			default:
...
var _user$project$Danamku$init = {
	ctor: '_Tuple2',
	_0: A2(
		_user$project$Danamku$Model,
		'',
...
var _user$project$Danamku$KeyMessage = function (a) {
	return {ctor: 'KeyMessage', _0: a};
};
var _user$project$Danamku$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Danamku$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$core$Time$every, _elm_lang$core$Time$millisecond, _user$project$Danamku$Tick),
				_elm_lang$keyboard$Keyboard$presses(_user$project$Danamku$KeyMessage)
			]));
};
var _user$project$Danamku$Send = {ctor: 'Send'};
var _user$project$Danamku$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _user$project$Danamku$textField = function (str) {
	return A2(
		_elm_lang$html$Html$input,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$type$('text'),
				_elm_lang$html$Html_Events$onInput(_user$project$Danamku$Input),
				_elm_lang$html$Html_Attributes$value(str)
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$Danamku$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Danamku$textField(model.input),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Danamku$Send)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Send')
					])),
				_user$project$Danamku$viewCollage(model.database)
			]));
};
var _user$project$Danamku$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Danamku$init, view: _user$project$Danamku$view, update: _user$project$Danamku$update, subscriptions: _user$project$Danamku$subscriptions})
};

var _user$project$GifSearchEngine$echoServer = 'wss://echo.websocket.org';
var _user$project$GifSearchEngine$decodeGifUrl = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['data', 'image_url']),
	_elm_lang$core$Json_Decode$string);
var _user$project$GifSearchEngine$listImage = function (model) {
	var toList = function (a) {
		return A2(
			_elm_lang$html$Html$img,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$src(a)
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	};
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$List$map, toList, model.gifUrl));
};
var _user$project$GifSearchEngine$Model = F3(
	function (a, b, c) {
		return {topic: a, input: b, gifUrl: c};
	});
var _user$project$GifSearchEngine$NewMessage = function (a) {
	return {ctor: 'NewMessage', _0: a};
};
var _user$project$GifSearchEngine$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, _user$project$GifSearchEngine$echoServer, _user$project$GifSearchEngine$NewMessage);
};
var _user$project$GifSearchEngine$Send = {ctor: 'Send'};
var _user$project$GifSearchEngine$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _user$project$GifSearchEngine$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Gif Search Engine')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$placeholder('English Only'),
								_elm_lang$html$Html_Events$onInput(_user$project$GifSearchEngine$Input),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$GifSearchEngine$Send)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Send')
				...
				_user$project$GifSearchEngine$listImage(model)
			]));
};
var _user$project$GifSearchEngine$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _user$project$GifSearchEngine$FetchSucceed = function (a) {
	return {ctor: 'FetchSucceed', _0: a};
};
var _user$project$GifSearchEngine$getRandomGif = function (topic) {
	var url = A2(_elm_lang$core$Basics_ops['++'], 'https://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag=', topic);
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$GifSearchEngine$FetchFail,
		_user$project$GifSearchEngine$FetchSucceed,
		A2(_evancz$elm_http$Http$get, _user$project$GifSearchEngine$decodeGifUrl, url));
};
var _user$project$GifSearchEngine$init = {
	ctor: '_Tuple2',
	_0: A3(
		_user$project$GifSearchEngine$Model,
		'aikatsu',
		'',
		_elm_lang$core$Native_List.fromArray(
			[''])),
	_1: _user$project$GifSearchEngine$getRandomGif('aikatsu')
};
var _user$project$GifSearchEngine$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'FetchSucceed':
				return {
					...
					_0: A3(
						...
						model.topic,
						model.input,
						A2(_elm_lang$core$List_ops['::'], _p0._0, model.gifUrl)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'FetchFail':
			...
			case 'Input':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$GifSearchEngine$Model, model.topic, _p0._0, model.gifUrl),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Send':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$websocket$WebSocket$send, _user$project$GifSearchEngine$echoServer, model.input)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$GifSearchEngine$getRandomGif(_p0._0)
				};
		}
	});
var _user$project$GifSearchEngine$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$GifSearchEngine$init, view: _user$project$GifSearchEngine$view, update: _user$project$GifSearchEngine$update, subscriptions: _user$project$GifSearchEngine$subscriptions})
};

var _user$project$ShowImage$makeImage2 = A3(_evancz$elm_graphics$Element$image, 400, 400, 'http://aikatsup.com/media/images/2151.jpeg');
var _user$project$ShowImage$makeImage = A3(_evancz$elm_graphics$Element$image, 800, 800, 'http://aikatsup.com/media/images/2157.jpeg');
var _user$project$ShowImage$makeCollage = F2(
	function (i, j) {
		return A3(
			_evancz$elm_graphics$Collage$collage,
			800,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Basics$degrees(i),
					_evancz$elm_graphics$Collage$toForm(_user$project$ShowImage$makeImage)),
					A2(
					_evancz$elm_graphics$Collage$rotate,
					_elm_lang$core$Basics$degrees(j) - 10,
					_evancz$elm_graphics$Collage$toForm(_user$project$ShowImage$makeImage))
				]));
	});
var _user$project$ShowImage$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$ShowImage$Model = function (a) {
	return {image: a};
};
var _user$project$ShowImage$init = {
	ctor: '_Tuple2',
	_0: _user$project$ShowImage$Model(_user$project$ShowImage$makeImage),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$ShowImage$update = F2(
	function (msg, model) {
		var _p0 = msg;
		var _p1 = _p0._0;
		return {
			ctor: '_Tuple2',
			_0: _user$project$ShowImage$Model(
				A3(
					_evancz$elm_graphics$Collage$collage,
					800,
					800,
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Basics$degrees(
								_elm_lang$core$Time$inMilliseconds(_p1) / 2),
							_evancz$elm_graphics$Collage$toForm(_user$project$ShowImage$makeImage)),
							A2(
							_evancz$elm_graphics$Collage$rotate,
							_elm_lang$core$Basics$degrees(
								_elm_lang$core$Time$inMilliseconds(_p1) / 10) + 45,
							_evancz$elm_graphics$Collage$toForm(_user$project$ShowImage$makeImage2))
						]))),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$ShowImage$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$ShowImage$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$millisecond, _user$project$ShowImage$Tick);
};
var _user$project$ShowImage$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$ShowImage$init, view: _user$project$ShowImage$view, update: _user$project$ShowImage$update, subscriptions: _user$project$ShowImage$subscriptions})
};

var Elm = {};
Elm['Danamku'] = Elm['Danamku'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Danamku'], 'Danamku', typeof _user$project$Danamku$main === 'undefined' ? null : _user$project$Danamku$main);
Elm['GifSearchEngine'] = Elm['GifSearchEngine'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['GifSearchEngine'], 'GifSearchEngine', typeof _user$project$GifSearchEngine$main === 'undefined' ? null : _user$project$GifSearchEngine$main);
Elm['ShowImage'] = Elm['ShowImage'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['ShowImage'], 'ShowImage', typeof _user$project$ShowImage$main === 'undefined' ? null : _user$project$ShowImage$main);
